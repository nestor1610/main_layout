...
export class NavCollapseComponent implements OnInit {
  ...
  navCollapse(e) {
    ...
    let lastParent = parent.parentElement.parentElement.parentElement;
    ...
    } else if (preParent.classList.contains('pcoded-submenu')) {console.log("ddddd", firstParent);
      do {
        preParent.parentElement.classList.add('pcoded-trigger');
        preParent = preParent.parentElement.parentElement.parentElement;
      } while (preParent.classList.contains('pcoded-submenu'));
    }else if (lastParent.classList.contains('pcoded-submenu')) {
      console.log ("dfdf", lastParent);
      do {
        lastParent.parentElement.classList.add('pcoded-trigger');
        lastParent = lastParent.parentElement.parentElement.parentElement;
      } while (lastParent.classList.contains('pcoded-submenu'));
    }
